...
<div className="card w-96 bg-base-100 shadow-xl" style={{marginLeft:"28%",marginRight:"40%", marginTop:"1%", width:"50%"}}>
  <div className="card-body">
    <h2 className="card-title" style={{marginLeft:"40%"}}>Personal data</h2>
        <div className="form-control w-full max-w-xs">
          {/* <div style={{display:"flex"}}> */}
            <label className="label">
              <span className="label-text" style={{width:"80px"}}>First Name</span>
            </label>
